...
<head>
    ...
    <link rel="stylesheet" href="termosM.css">
...
<form action="../carrito.php" method="POST">
    <div class="producto-detalle">
        <a class="btn-regresar" href="../productos/mediano.php">
            <span>&lt;</span> Regresar
        </a>
        <div class="imagen-producto">
            
            <img class="termo-imagen" src="../ImgPro/termo_cilindro_blanco.webp" alt="Termo Cilindro">
        </div>
        <div class="info-producto">
            <h2>Termo Cilindro</h2>
            <p class="precio">$649.99</p>
